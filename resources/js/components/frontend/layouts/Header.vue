                ...
                <div class="header_inner mcontainer">
                    <div class="left_side">
                        ...
                        <div id="logo">
                            <a href="homepage.html"> 
                                <img src="public/frontend/assets/images/logo.png" alt="" style="height:60px !important;">
                  ...
                  <!-- search icon for mobile -->
                    ...
                    <div class="header_search"><i class="uil-search-alt"></i> 
                        <input value="" type="text" class="form-control" placeholder="Search for Contacts" autocomplete="off">
                        <div uk-drop="mode: click" class="header_search_dropdown">
                            ...
                            <ul>
                                <li> 
                                    <a href="#">  
                                        <img src="public/frontend/assets/images/avatars/avatar-1.jpg" alt="" class="list-avatar">
                                        <div class="list-name">  Erica Jones </div>
                                    </a> 
                                </li> 
                                <li> 
                                    <a href="#">  
                                        <img src="public/frontend/assets/images/avatars/avatar-2.jpg" alt="" class="list-avatar">
                                        <div class="list-name">  Coffee  Addicts </div>
                                    </a> 
                                </li>
                                <li> 
                                    <a href="#">  
                                        <img src="public/frontend/assets/images/avatars/avatar-3.jpg" alt="" class="list-avatar">
                                        <div class="list-name"> Mountain Riders </div>
                                    </a> 
                                </li>
                                <li> 
                                    <a href="#">  
                                        <img src="public/frontend/assets/images/avatars/avatar-4.jpg" alt="" class="list-avatar">
                                        <div class="list-name"> Property Rent And Sale  </div>
                                    </a> 
                                </li>
                                <li> 
                                    <a href="#">  
                                        <img src="public/frontend/assets/images/avatars/avatar-5.jpg" alt="" class="list-avatar">
                                        <div class="list-name">  Erica Jones </div>
                                    </a> 
                                </li>
                            </ul>
                    ...
                    <div class="right_side">
                        ...
                        <div class="header_widgets">
                                ...
                                <ul class="dropdown_cart_scrollbar" data-simplebar>
                                    <li>
                                        <div class="cart_avatar">
                                            <img src="public/frontend/assets/images/product/2.jpg" alt="">
                                        </div>
                                        <div class="cart_text">
                                    ...
                                    <li>
                                        <div class="cart_avatar">
                                            <img src="public/frontend/assets/images/product/13.jpg" alt="">
                                        </div>
                                        <div class="cart_text">
                                    ...
                                    <li>
                                        <div class="cart_avatar">
                                            <img src="public/frontend/assets/images/product/15.jpg" alt="">
                                        </div>
                                        <div class="cart_text">
                                    ...
                                    <li>
                                        <div class="cart_avatar">
                                            <img src="public/frontend/assets/images/product/14.jpg" alt="">
                                        </div>
                                        <div class="cart_text">
                                    ...
                                    <li>
                                        <div class="cart_avatar">
                                            <img src="public/frontend/assets/images/product/9.jpg" alt="">
                                        </div>
                                        <div class="cart_text">
                            ...
                            <div uk-drop="mode: click" class="header_dropdown">
                                 <div  class="dropdown_scrollbar" data-simplebar>
                                     ...
                                     <ul>
                                         <li>
                                             <a href="#">
                                                 <div class="drop_avatar"> 
                                                     <img src="public/frontend/assets/images/avatars/avatar-1.jpg" alt="">
                                                 </div>
                                         ...
                                         <li class="not-read">
                                             <a href="#">
                                                 <div class="drop_avatar status-online"> <img src="public/frontend/assets/images/avatars/avatar-2.jpg" alt="">
                                                 </div>
                                                 <div class="drop_text">
                                                     <p>
                                         ...
                                         <li>
                                             <a href="#">
                                                 <div class="drop_avatar"> <img src="public/frontend/assets/images/avatars/avatar-3.jpg" alt="">
                                                 </div>
                                                 <span class="drop_icon bg-gradient-primary">
                                                    <i class="icon-feather-thumbs-up"></i>
                                                </span>
                                         ...
                                         <li>
                                             <a href="#">
                                                 <div class="drop_avatar"> <img src="public/frontend/assets/images/avatars/avatar-1.jpg" alt="">
                                                 </div>
                                                 <div class="drop_text">
                                                     <p>
                                         ...
                                         <li>
                                             <a href="#">
                                                 <div class="drop_avatar"> <img src="public/frontend/assets/images/avatars/avatar-2.jpg" alt="">
                                                 </div>
                                                 <div class="drop_text">
                                                     <p>
                                                        <strong>Stella Johnson</strong> Replay Your Comments in
                            ...
                            <div uk-drop="mode: click" class="header_dropdown is_message">
                                <div  class="dropdown_scrollbar" data-simplebar>
                                    ...
                                    <ul>
                                        <li class="un-read">
                                            <a href="#">
                                                <div class="drop_avatar"> <img src="public/frontend/assets/images/avatars/avatar-7.jpg" alt="">
                                                </div>
                                                <div class="drop_text">
                                        ...
                                        <li>
                                            <a href="#">
                                                <div class="drop_avatar"> <img src="public/frontend/assets/images/avatars/avatar-6.jpg" alt="">
                                                </div>
                                                <div class="drop_text">
                                        ...
                                        <li>
                                            <a href="#">
                                                <div class="drop_avatar"> <img src="public/frontend/assets/images/avatars/avatar-5.jpg" alt="">
                                                </div>
                                                <div class="drop_text">
                                        ...
                                        <li>
                                            <a href="#">
                                                <div class="drop_avatar"> <img src="public/frontend/assets/images/avatars/avatar-4.jpg" alt="">
                                                </div>
                                                <div class="drop_text">
                                                    <strong> Jonathan Madano </strong> <time> Sun</time>
                                                    <p>  Replay Your Comments insit amet consectetur </p>
                            ...
                            <a href="#">
                                <img src="public/frontend/assets/images/avatars/avatar-2.jpg" class="is_avatar" alt="">
                            </a>
                            <div uk-drop="mode: click;offset:5" class="header_dropdown profile_dropdown">

                                <a href="timeline.html" class="user">
                                    <div class="user_avatar">
                                        <img src="public/frontend/assets/images/avatars/avatar-2.jpg" alt="">
                                    </div>
                                    <div class="user_name">
