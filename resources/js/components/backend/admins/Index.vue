...
export default {
    ...
    created(){
        this.getApi = "admin-user"
        this.columnsHead.push('Sn',' Name','User Name', 'Email', 'Mobile No.', 'Action')
        this.columnsBody.push('name','user_name','email','phone',)
        this.cardTitle ="SM/GM List"
        this.excelTitle = "SM List"
        this.isEditBtn  = true
