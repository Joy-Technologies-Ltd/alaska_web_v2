...
{{--                                style="width:150%;">--}}
                            <form method="post" action="{{route('sign-in')}}"> @csrf
                                ...
                                <div class="headline"></div>
                                    ...
                                    <a href="{{url('/sign-up')}}" id="myButton" style="background-color: #42b72a;"
                                        class="bg-blue-600 font-semibold p-2 mt-3 rounded-md text-center text-white w-full">Create
                                        New Account!</a>
                            ...
                            <div class="footer-widget footer-contact">
                                ...
                                <div class="footer-contact-info">
                                    <div class="footer-address">
                                        ...
                                        <p style="color:white;"> D58(5th Floor) Road#8,Niketon, <br> Gulshan-1,
                            ...
                            <div class="col-md-6 col-lg-6">
                                ...
                                <div class="copyright-menu">
                                    <ul class="policy-menu">
                                        <li><a style="color:white;" href=" url('service/terms-and-conditions') ">Terms
                                                and Conditions</a>
                                        </li>
                                        <li><a style="color:white;" href=" url('service/privacy-policy') ">Policy</a>
                                        </li>
                                    </ul>
                                </div>
                                <!-- /Copyright Menu -->
