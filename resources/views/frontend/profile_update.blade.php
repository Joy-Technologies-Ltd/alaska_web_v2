                            ...
                            <form @submit.prevent="signUpWithPersonalInfo"
                                ...
                                <div v-if="showDoneForm">
                                    ...
                                    <div>
                                        ...
                                        {{-- <v-select id="mySelect" class=" bg-gray-100 h-12 mt-2 px-3 rounded-md w-full"
                                            name="gender" :options="genders" label="gender_name"
                                            :reduce="gender => gender.id" v-model="siginUpForm.gender"
                                    ...
                                    <div>
                                        ...
                                        {{-- <v-select id="mySelect" class=" bg-gray-100 h-12 mt-2 px-3 rounded-md w-full"
                                            name="country_id" :options="countries" label="name"
                                            :reduce="country => country.id" v-model="siginUpForm.country_id"
                                    ...
                                    <div>
                                        ...
                                        {{-- <v-select id="mySelect" class=" bg-gray-100 h-12 mt-2 px-3 rounded-md "
                                            name="language_id" :options="languages" label="name"
                                            :reduce="language => language.id" v-model="siginUpForm.language_id"
